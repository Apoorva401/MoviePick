    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6 text-foreground">Terms of Use</h1>
          <p className="text-muted-foreground mb-8">
            Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
          </p>

          <div className="prose prose-slate dark:prose-invert max-w-none text-gray-300 prose-headings:text-gray-100">
            <h2 className="text-gray-100">1. Acceptance of Terms</h2>
            <p>
              By accessing and using MoviePick ("the Service"), you agree to be bound by these Terms of Use. If you do not 
              agree to these terms, please do not use the Service.
            </p>

            <h2 className="text-gray-100">2. Description of Service</h2>
            <p>
            ...
            <h2 className="text-gray-100">3. User Accounts</h2>
            <p>
            ...
            <h2 className="text-gray-100">4. User Content</h2>
            <p>
            ...
            <h2 className="text-gray-100">5. Prohibited Conduct</h2>
            ...
            <h2 className="text-gray-100">6. Intellectual Property</h2>
            <p>
            ...
            <h2 className="text-gray-100">7. Termination</h2>
            <p>
            ...
            <h2 className="text-gray-100">8. Disclaimer of Warranties</h2>
            <p>
            ...
            <h2 className="text-gray-100">9. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-gray-100">10. Changes to Terms</h2>
            <p>
            ...
            <h2 className="text-gray-100">11. Contact Information</h2>
            <p>
