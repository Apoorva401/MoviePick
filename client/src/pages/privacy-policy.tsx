      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none text-gray-300 prose-headings:text-gray-100">
            <h2 className="text-gray-100">1. Introduction</h2>
            <p>
            ...
            <h2 className="text-gray-100">2. Information We Collect</h2>
            <h3 className="text-gray-100">Account Information</h3>
            ...
            <h3 className="text-gray-100">Usage Information</h3>
            ...
            <h3 className="text-gray-100">Technical Information</h3>
            ...
            <h2 className="text-gray-100">3. How We Use Your Information</h2>
            ...
            <h2 className="text-gray-100">4. How We Share Your Information</h2>
            <p>
            ...
            <h2 className="text-gray-100">5. Data Security</h2>
            <p>
            ...
            <h2 className="text-gray-100">6. Your Rights and Choices</h2>
            ...
            <h2 className="text-gray-100">7. Children's Privacy</h2>
            <p>
            ...
            <h2 className="text-gray-100">8. Changes to This Privacy Policy</h2>
            <p>
            ...
            <h2 className="text-gray-100">9. Contact Us</h2>
            <p>
